...
export const CONTRACT_ADDRESSES = {
  InheritanceCore: '0x...' as Address, // Replace with actual deployed address
  TimingManager: '0x...' as Address,   // Replace with actual deployed address
  EmergencyManager: '0x...' as Address // Replace with actual deployed address
}
...
export const INHERITANCE_CORE_ABI = [
  // Core functions
  {
    "inputs": [
      ...
      {"internalType": "tuple", "name": "timeLock", "type": "tuple",
        "components": [
          {"internalType": "enum DistributionType", "name": "distributionType", "type": "uint8"},
          {"internalType": "uint256", "name": "unlockTime", "type": "uint256"},
          {"internalType": "uint256", "name": "vestingDuration", "type": "uint256"},
          {"internalType": "uint256", "name": "cliffDuration", "type": "uint256"},
          {"internalType": "uint256[]", "name": "milestoneTimestamps", "type": "uint256[]"},
          {"internalType": "uint256[]", "name": "milestonePercentages", "type": "uint256[]"}
        ]
      }
    ],
    "name": "createInheritance",
    "outputs": [{"internalType": "uint256", "name": "inheritanceId", "type": "uint256"}],
  ...
  },
  {
    "inputs": [
      ...
      {"internalType": "uint256", "name": "allocationBasisPoints", "type": "uint256"}
    ],
    "name": "addBeneficiary",
    "outputs": [],
    "stateMutability": "nonpayable",
  ...
  {
    "inputs": [{"internalType": "uint256", "name": "inheritanceId", "type": "uint256"}],
    "name": "depositETH",
    "outputs": [],
  ...
  },
  {
    ...
    "outputs": [{
      ...
      "components": [
        ...
        {"internalType": "string", "name": "name", "type": "string"},
        {"internalType": "enum InheritanceStatus", "name": "status", "type": "uint8"},
        {"internalType": "uint256", "name": "createdAt", "type": "uint256"},
        {"internalType": "uint256", "name": "triggeredAt", "type": "uint256"},
        {"internalType": "uint256", "name": "totalETHDeposited", "type": "uint256"},
  ...
  // Events
  {
    "anonymous": false,
    "inputs": [
      {"indexed": true, "internalType": "uint256", "name": "inheritanceId", "type": "uint256"},
  ...
  },
  {
    ...
    "inputs": [
      ...
      {"indexed": false, "internalType": "uint256", "name": "allocationBasisPoints", "type": "uint256"},
      {"indexed": false, "internalType": "uint256", "name": "timestamp", "type": "uint256"}
    ],
