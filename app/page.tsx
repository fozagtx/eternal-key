...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="text-center space-y-8 sm:space-y-12 lg:space-y-16 px-4 sm:px-6 max-w-5xl relative z-10">
        <div className="space-y-6 sm:space-y-8 mt-2">
          <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-gradient-to-r from-blue-100/80 to-cyan-100/80 rounded-full border border-blue-200/60 backdrop-blur-sm">
            <span className="text-xs sm:text-sm font-medium text-blue-800 animate-pulse">
              currently in beta
            </span>
          </div>
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed px-2">
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:gap-4">
          <GetStartedButton
            size="lg"
            className="w-full sm:w-auto shadow-xl shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300"
          />
        </div>
